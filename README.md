...
| 算数运算指令 | 循环右移、低位乘累加、低位乘累减等功能 | :ballot_box_with_check: |
| 存储指令  | 移位双字加载，符号位扩展字加载、移位双字存储等功能     | :ballot_box_with_check: |  
| 位操作指令  | 快速找0或1、寄存器连续位提取、字节倒序等功能     | :ballot_box_with_check: |
